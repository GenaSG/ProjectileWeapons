...
/*
	...
	{
	  if(getDvar("svr_pezbots_botKickProcess") != "" && getDvarInt("svr_pezbots_botKickProcess") == 1)
	  {
      //setDvar("sv_maxclients", getDvarInt("svr_pezbots_humanPlayerCount"));	
      setDvar("sv_maxclients", 1);	
      setDvar("svr_pezbots_botKickProcess", 0);
      map_restart(true);
      return;
	  }
	  else
