...
vehicle_80s_sedan1( color )
{
	...
	// 80's Sedan
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_sedan1_" + color, undefined, undefined, 32, "no_melee" );
...
vehicle_80s_wagon1( color )
{
	...
	// 80's wagon
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_wagon1_" + color, undefined, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
vehicle_80s_hatch1( color )
{
	...
	// 80's hatchback
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_hatch1_" + color, undefined, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
vehicle_small_wagon( color )
{
	...
	// small wagon
	//---------------------------------------------------------------------
	destructible_create( "vehicle_small_wagon_" + color, undefined, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
vehicle_small_hatch( color )
{
	...
	// small hatch
	//---------------------------------------------------------------------
	destructible_create( "vehicle_small_hatch_" + color, undefined, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
vehicle_80s_hatch2( color )
{
	...
	// 80's hatchback 2
	//---------------------------------------------------------------------
	destructible_create( "vehicle_80s_hatch2_" + color, undefined, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
...
vehicle_uaz_fabric( destructibleType )
{
	destructible_create( "vehicle_uaz_fabric_", undefined, undefined, 32, "no_melee" );
...
vehicle_uaz_open( destructibleType )
{
	destructible_create( "vehicle_uaz_open", undefined, undefined, 32, "no_melee" );
...
vehicle_uaz_light( destructibleType )
{
	destructible_create( "vehicle_uaz_light", undefined, undefined, 32, "no_melee" );
...
vehicle_uaz_hardtop( destructibleType )
{
	destructible_create( "vehicle_uaz_hardtop", undefined, undefined, 32, "no_melee" );
